export const ZERODHA_CSV = `symbol,isin,trade_date,trade_type,quantity,price,trade_id,order_id,exchange,segment
...
export const IBKR_CSV = `TradeID,AccountID,Symbol,DateTime,Buy/ Sell,Quantity,TradePrice,Currency,Commission,NetAmount,AssetClass
